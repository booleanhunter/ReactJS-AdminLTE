define(
  [
    ...
    './page-ui-elements/custom-tabs/custom-tabs',
  ],
  function (React, $, HeaderBar, NavigationMenu, ColorPaletteSet, Box, Alert, Callout, CustomTabs) {
    var UIElements = React.createClass({
      ...
      render: function () {
        ...
        className = "breadcrumb" >
          < li > < a
        href = "#" > < i
        className = "fa fa-dashboard" > < / i > Home < / a > < / li >
          < li > < a
        href = "#" > UI < / a > < / li >
          < li
        className = "active" > General < / li >
          < / ol >
          < / section >
        ...
        content = "This is a green callout" / >
          ...
          < h2
        className = "page-header" > AdminLTE
        Custom
        Tabs < / h2 >
        ...
        < / li >
        < li
        className = "pull-left header" > < i
        className = "fa fa-th" > < / i > Custom
        Tabs < / li >
        < / ul >
        < div
