  ...
  function (React, ReactDOM) {
    var Box = React.createClass({
      ...
      render: function () {
        ...
        <
          div
          className = "box-tools pull-right" > {boxTools} < / div >
        }
        ...
        <
          div
          className = "box-footer" > {this.props.footer
        }</
          div >
        }
        ...
        className = {"col-md-"+this.props.width + " col-sm-6 col-xs-12"} >
          < div
        className = {"box "+this.props.theme + " " + borderClass + " " + this.props.customClass + " " + boxType} >
          < div
        className = "box-header with-border" >
          < h3
        className = "box-title" > {this.props.headerMarkup
      }
        {
          this.props.title
        }
