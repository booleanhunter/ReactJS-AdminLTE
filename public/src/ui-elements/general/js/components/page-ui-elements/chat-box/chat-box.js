    ...
    var ChatBox = React.createClass({
      ...
      render: function () {
        ...
        className = "box-header with-border" >
          < h3
        className = "box-title" > {this.props.title
      }</
        h3 >
        < div
        ...
        data - toggle = "tooltip"
        title = ""
        className = {"badge "+this.props.notificationTheme}
        ...
        className = "input-group-btn" >
          < button
        type = "button"
        className = {"btn btn-flat "+this.props.buttonTheme} > Send < / button >
          < / span >
          < / div >
          < / form >
          < / div >
